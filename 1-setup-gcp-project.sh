#!/bin/bash
# Complete GCP Project Setup for Bible Search

set -e

echo "========================================"
echo "GCP Project Setup for Bible Search"
echo "========================================"
echo ""

# Get project ID from user
read -p "Enter your GCP Project ID (e.g., bible-search-123456): " PROJECT_ID
...
# Create .gcp-config file for deployment
echo "5️⃣  Creating deployment configuration..."

cat > .gcp-config << EOF
# GCP Configuration for Bible Search
export PROJECT_ID="$PROJECT_ID"
export REGION="us-central1"
export SERVICE_NAME="bible-search"
export IMAGE_NAME="gcr.io/$PROJECT_ID/bible-search"
EOF
